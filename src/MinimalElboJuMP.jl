# This module implements a minimal version of the ELBO log likelihood in JuMP.

module MinimalElboJuMP
...
function build_jump_model(blobs::Blob, mp::ModelParams)
    ...
    # TODO: Despite this maximum, I'm going to treat the rest of the code as if
