    ...
    for source_row in catalog_rows:
        ...
        if source_row['is_star'] == 'true':
            ...
            source = (
                ...
                .axis_ratio(field('gal_axis_ratio'))
...
def main():
    ...
    arg_parser.add_argument('images_fits')
    ...
    galsim_common.generate_fits_file(args.images_fits, [celeste_field_test])
