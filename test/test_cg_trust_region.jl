...
@testset "Toy test problem 1" begin
    ...
    result = Optim.optimize(d, [0.0], CGTrustRegion())
...
@testset "Toy test problem 2" begin
    ...
    result = Optim.optimize(d2, Float64[127, 921], CGTrustRegion())
...
@testset "Stock test problems" begin
    for (name, prob) in Optim.UnconstrainedProblems.examples
    	if prob.istwicedifferentiable
    		...
    		result = Optim.optimize(ddf, prob.initial_x, CGTrustRegion())
